...
typedef struct fcontext_stack_s
{
    void* sptr;
    size_t ssize;
}fcontext_stack_t;
...
extern int* BOTCOT_CALLDECL jump_fcontext(fcontext_t* ofc, fcontext_t nfc,
                                           int* vp, char preserve_fpu);

extern fcontext_t BOTCOT_CALLDECL make_fcontext(void* sp, size_t size,
                                                 void (*fn)(int*));
